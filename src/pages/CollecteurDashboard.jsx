...
const loadProfil = async () => {
  ...
  try {
    ...
    if (response.ok) {
      ...
      // Mettre à jour currentUser avec toutes les données
      const updatedUser = {
        ...currentUser,
...
const filterGains = () => {
  // Le filtrage est géré directement dans GainsSection
  return;
};
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="lg:ml-72 min-h-screen">
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
         ...
         {activeSection === 'gains' && (
  <GainsSection
    gains={gains} // ← CORRIGÉ : gains au lieu de filteredGains
...
const GainsSection = ({ 
  ...
  // Filtrer les gains localement (pas de state supplémentaire)
