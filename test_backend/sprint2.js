...
//     // NOUVEAU : Récupération des photos CNI
//     const photoCniRectoUrl = document.getElementById('collecteur-cni-recto').value;
//     const photoCniVersoUrl = document.getElementById('collecteur-cni-verso').value;

//     // Vérification que les photos CNI sont présentes
//     if (!photoCniRectoUrl || !photoCniVersoUrl) {
//         showMessage(
//             document.getElementById('collecteur-inscription-message'),
//             'Veuillez charger les photos recto ET verso de votre CNI',
//             'error'
//         );
//         return;
//     }
...
//     try {
//         console.log('📤 Inscription collecteur avec photos CNI:', {
//             ...data,
//             photoCniRectoUrl: data.photoCniRectoUrl ? '[PRÉSENT]' : '[MANQUANT]',
//             photoCniVersoUrl: data.photoCniVersoUrl ? '[PRÉSENT]' : '[MANQUANT]'
//         });
