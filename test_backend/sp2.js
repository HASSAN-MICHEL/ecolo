...
// // api.js - Version corrigée et alignée avec le backend
...
//     const data = {
//         email: document.getElementById('collecteur-email').value,
//         telephone: document.getElementById('collecteur-telephone').value,
//         motDePasse: document.getElementById('collecteur-password').value,
//         nomComplet: document.getElementById('collecteur-nom').value,
//         typeCollecteur: document.getElementById('collecteur-type').value,
//         numeroIdentite: document.getElementById('collecteur-numero-identite').value || undefined,
//         zoneInterventionNom: document.getElementById('collecteur-zone-nom').value,
//         quartiersHabituels: document.getElementById('collecteur-quartiers').value.split(',').map(q => q.trim()).filter(q => q),
//         communesIntervention: document.getElementById('collecteur-communes').value.split(',').map(c => c.trim()).filter(c => c),
//         photoProfilUrl: document.getElementById('collecteur-photo').value || undefined,
//         cguAcceptees: document.getElementById('collecteur-cgu').checked
//     };

//     const messageDiv = document.getElementById('collecteur-inscription-message');

//     try {
//         console.log('📤 Inscription collecteur:', data);
...
//         // ✅ CORRECTION: Utiliser /connexion au lieu de /LOHION
...
//             }
//         } else {
//             console.error('❌ Erreur chargement missions:', result.message);
//         }
//     } catch (error) {
//         console.error('❌ Erreur:', error);
//         document.getElementById('missions-disponibles').innerHTML = 
//             '<p class="text-center error">Erreur de chargement</p>';
//     }
// }
...
//     if (currentUser) {
//         document.getElementById('profil-nom').textContent = currentUser.nomComplet || 'N/A';
//         document.getElementById('profil-email').textContent = currentUser.email || 'N/A';
//         document.getElementById('profil-telephone').textContent = currentUser.telephone || 'N/A';
//         document.getElementById('profil-type').textContent = currentUser.typeCollecteur || 'N/A';
//         document.getElementById('profil-zone').textContent = currentUser.zone_intervention_nom || 'Non spécifiée';
//         document.getElementById('profil-statut').textContent = currentUser.statut || 'N/A';
        
//         document.getElementById('modif-nom').value = currentUser.nomComplet || '';
//         document.getElementById('modif-telephone').value = currentUser.telephone || '';
//         document.getElementById('modif-zone').value = currentUser.zone_intervention_nom || '';
//     }
// }
...
//         const result = await response.json();
//         console.log('📊 Dashboard collecteur:', result);

//         if (result.success) {
//             // Mettre à jour les statistiques
//             document.getElementById('dashboard-total-missions').textContent = result.dashboard?.total_missions || 0;
//             document.getElementById('dashboard-missions-validees').textContent = result.dashboard?.missions_validees || 0;
//             document.getElementById('dashboard-missions-en-cours').textContent = result.dashboard?.missions_en_cours || 0;
//             document.getElementById('dashboard-dechets').textContent = result.dashboard?.total_dechets_collectes || 0;

//             // Afficher la mission en cours
//             const missionEnCoursDiv = document.getElementById('mission-en-cours');
//             if (result.missionEnCours) {
//                 const m = result.missionEnCours;
//                 missionEnCoursDiv.innerHTML = `
//                     <div class="card" style="background: #e3f2fd;">
//                         <p><strong>Mission #${(m.id || '').substring(0,8)}</strong></p>
//                         <p><i class="fas fa-user"></i> Producteur: ${m.producteur_nom || 'Inconnu'}</p>
//                         <p><i class="fas fa-trash"></i> Déchets: ${m.quantite || 0} ${m.unite || 'kg'} de ${m.type_dechet || 'Non spécifié'}</p>
//                         <p><i class="fas fa-map-marker"></i> Adresse: ${m.producteur_adresse || 'Non spécifiée'}</p>
//                         <p><i class="fas fa-phone"></i> Tél: ${m.producteur_telephone || 'N/A'}</p>
//                     </div>
//                 `;
//             } else {
//                 missionEnCoursDiv.innerHTML = '<p class="text-center">Aucune mission en cours</p>';
//             }

//             // Afficher l'historique des missions
//             const historiqueDiv = document.getElementById('historique-missions');
//             if (historiqueDiv && result.historique) {
//                 if (result.historique.length === 0) {
//                     historiqueDiv.innerHTML = '<p class="text-center">Aucune mission dans l\'historique</p>';
//                 } else {
//                     historiqueDiv.innerHTML = result.historique.map(m => `
//                         <div class="item">
//                             <div class="item-header">
//                                 <span class="item-title">${m.type_dechet || 'Mission'}</span>
//                                 <span class="badge ${getStatusBadgeClass(m.statut)}">${m.statut || 'inconnu'}</span>
//                             </div>
//                             <div class="item-body">
//                                 <p>Producteur: ${m.producteur_nom || 'Inconnu'}</p>
//                                 <p>Poids: ${m.poids_depose || 0} kg</p>
//                                 <p>Gains: ${m.gains_attribues || 0} FCFA</p>
//                                 <p>Date: ${m.date_validation ? new Date(m.date_validation).toLocaleDateString() : 'N/A'}</p>
//                             </div>
//                         </div>
//                     `).join('');
//                 }
...
//         if (result.success) {
//             showMessage(messageDiv, 'Profil mis à jour', 'success');
//             loadProfil();
//         } else {
//             throw new Error(result.message || 'Erreur');
//         }
...
//     try {
//         await Promise.all([
//             loadMissionsEnAttente(),
//             loadGestionnaireStats()
//         ]);
//     } catch (error) {
...
//             } else {
//                 container.innerHTML = result.missions.map(m => `
//                     <div class="item" onclick="document.getElementById('valider-mission-id').value='${m.id}'">
//                         <div class="item-header">
//                             <span class="item-title">Mission #${(m.id || '').substring(0,8)}</span>
//                             <span class="badge badge-warning">${m.statut || 'en_attente'}</span>
//                         </div>
//                         <div class="item-body">
//                             <p><i class="fas fa-user"></i> Collecteur: ${m.collecteur_nom || 'Inconnu'}</p>
//                             <p><i class="fas fa-trash"></i> ${m.type_dechet || 'Non spécifié'}</p>
//                             <p><i class="fas fa-calendar"></i> ${m.date_depot_point ? new Date(m.date_depot_point).toLocaleString() : 'N/A'}</p>
//                         </div>
//                     </div>
//                 `).join('');
//             }
...
// //             if (statsContainer && result.dashboard) {
// //                 statsContainer.innerHTML = `
// //                     <div class="stat-card">
// //                         <h4>Total réceptions</h4>
// //                         <p class="stat-value">${result.dashboard.total_receptions || 0}</p>
// //                     </div>
// //                     <div class="stat-card">
// //                         <h4>Poids total</h4>
// //                         <p class="stat-value">${result.dashboard.total_poids_recu || 0} kg</p>
// //                     </div>
// //                     <div class="stat-card">
// //                         <h4>Aujourd'hui</h4>
// //                         <p class="stat-value">${result.dashboard.receptions_aujourdhui || 0}</p>
// //                     </div>
// //                 `;
// //             }
// //         }
...
//     try {
//         console.log('📡 Chargement des stats gestionnaire...');
//         const response = await fetch(`${API_URL}/api/gestionnaires/tableau-bord`, {
//             headers: { 'Authorization': `Bearer ${currentToken}` }
//         });
...
//             // Afficher les missions récentes
//             const missionsRecentesDiv = document.getElementById('missions-recentes');
//             if (missionsRecentesDiv) {
//                 const missions = result.missions_recentes || [];
//                 if (missions.length === 0) {
//                     missionsRecentesDiv.innerHTML = '<p class="text-center">Aucune mission récente</p>';
//                 } else {
//                     missionsRecentesDiv.innerHTML = missions.map(m => `
//                         <div class="item">
//                             <div class="item-header">
//                                 <span class="item-title">${m.type_dechet || 'Mission'}</span>
...
//                             <div class="item-body">
//                                 <p><i class="fas fa-user"></i> Collecteur: ${m.collecteur_nom || 'Inconnu'}</p>
//                                 <p><i class="fas fa-weight"></i> Poids: ${m.poids_depose || 0} kg</p>
//                                 <p><i class="fas fa-coins"></i> Gains: ${m.gains_attribues || 0} FCFA</p>
//                                 <p><i class="fas fa-calendar"></i> ${m.date_validation ? new Date(m.date_validation).toLocaleDateString() : 'N/A'}</p>
//                             </div>
//                         </div>
//                     `).join('');
//                 }
...
//             // Afficher le top des collecteurs
//             const topCollecteursDiv = document.getElementById('top-collecteurs');
//             if (topCollecteursDiv) {
//                 const top = result.top_collecteurs || [];
//                 if (top.length === 0) {
//                     topCollecteursDiv.innerHTML = '<p class="text-center">Aucune donnée</p>';
//                 } else {
//                     topCollecteursDiv.innerHTML = top.map((c, index) => `
//                         <div class="item">
//                             <div class="item-header">
//                                 <span class="item-title">${index + 1}. ${c.nom_complet || 'Inconnu'}</span>
//                                 <span class="badge badge-info">${c.missions_validees || 0} missions</span>
//                             </div>
//                             <div class="item-body">
//                                 <p><i class="fas fa-weight"></i> Poids total: ${c.total_poids || 0} kg</p>
//                                 <p><i class="fas fa-coins"></i> Gains: ${c.total_gains || 0} FCFA</p>
//                             </div>
//                         </div>
//                     `).join('');
//                 }
...
//         }
//     } catch (error) {
//         console.error('❌ Erreur chargement stats gestionnaire:', error);
//     }
// }
...
//     const data = {
//         poidsDepose: parseFloat(document.getElementById('valider-poids').value),
//         qualiteDechets: document.getElementById('valider-qualite').value,
//         notes: document.getElementById('valider-notes').value
//     };

//     const messageDiv = document.getElementById('validation-message');

//     if (!missionId) {
//         showMessage(messageDiv, 'Sélectionnez une mission', 'error');
//         return;
//     }
...
//                             <input type="radio" name="missionSelection" value="${m.id}" id="mission_${m.id}" style="width: 20px; height: 20px; cursor: pointer;">
//                             <div style="flex: 1;">
