...
//                 creneauHoraire,
//                 notes,
//                 typesDechets // ici on utilise cela quand on veut declaré plusieur type different de dechats
//             } = req.body;
...
//                 declaration,
//                 suivre: {
//                     etapeActuelle: this.determinerEtape(declaration.statut),
//                     prochaineAction: this.getProchaineAction(declaration.statut),
...
//             const historique = await DeclarationDechets.obtenirHistorique(producteurId, parseInt(limite));
