...
//     // Accès lecture seule aux données
//     static async consulterIndicateurs(req, res) {
//         try {
//             const indicateurs = await Ong.indicateursEnvironnementaux();
//             const zones = await Ong.zonesCouvertes();
...
//     // Consulter les campagnes (lecture seule)
//     static async consulterCampagnes(req, res) {
//         try {
//             const { statut, typeDechet } = req.query;

//             const campagnes = await Campagne.lister({
//                 statut,
//                 typesDechets: typeDechet ? [typeDechet] : null
//             });
...
//             const rapport = await Ong.creerRapport({
//                 ongId,
//                 titre,
//                 description,
//                 fichierUrl,
...
//         try {
//             const ongId = req.utilisateurId;
//             const rapports = await Ong.listerRapports(ongId);
...
// controllers/OngController.js - Version corrigée
...
static async consulterCampagnes(req, res) {
    ...
    // ✅ CORRIGÉ : Indicateurs environnementaux
    static async consulterIndicateurs(req, res) {
        try {
