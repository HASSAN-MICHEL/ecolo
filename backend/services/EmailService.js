...
//         await this.envoyerCodeDev(email, code, nomComplet);
        
//         // Tentative d'envoi d'email réel
//         try {
//             const mailOptions = {
...
//         console.log('\n' + '🔐'.repeat(30));
//         console.log('🔐 CODE DE RÉINITIALISATION');
...
class EmailService {
    ...
    async envoyerCodeReinitialisation(email, code, nomComplet) {
        ...
        try {
            ...
            // ❌ LIGNE SUPPRIMÉE - celle qui causait l'erreur
            // const emailEnvoye = await EmailService.envoyerCodeReinitialisation(email, code, utilisateur.nom_complet);
            // console.log('✅ Résultat envoi:', emailEnvoye);
